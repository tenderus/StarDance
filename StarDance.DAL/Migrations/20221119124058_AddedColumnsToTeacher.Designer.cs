...
namespace StarDance.DAL.Migrations
{
    ...
    [Migration("20221119124058_AddedColumnsToTeacher")]
    partial class AddedColumnsToTeacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarDance.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LessonUser", b =>
                {
                    b.HasOne("StarDance.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StarDance.Domain.Absence", b =>
                {
                    b.HasOne("StarDance.Domain.User", "Client")
                        .WithMany("Absences")
            ...
            modelBuilder.Entity("StarDance.Domain.Teacher", b =>
                {
                    ...
                    b.HasOne("StarDance.Domain.User", "User")
                        .WithMany()
